package com.bootcamp.personal.passiveaccounts;
...
public class MsPersonalPassiveAccountsApplication implements CommandLineRunner {

	private static final Logger logger = Logger.getLogger(MsPersonalPassiveAccountsApplication.class.toString());
	...
	public static void main(String[] args) {
		SpringApplication.run(MsPersonalPassiveAccountsApplication.class, args);
	}
